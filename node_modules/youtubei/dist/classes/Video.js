...
class Video extends _1.BaseVideo {
    ...
    load(data) {
        ...
        this.comments = [];
        const continuation = (_c = (_b = (_a = contents[contents.length - 1]) === null || _a === void 0 ? void 0 : _a.itemSectionRenderer) === null || _b === void 0 ? void 0 : _b.continuations) === null || _c === void 0 ? void 0 : _c[0].nextContinuationData;
        if (continuation) {
